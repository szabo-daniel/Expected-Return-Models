#Daniel Szabo  Summer research project 2022 with John Lewis as advisor
...
rbind(ks_2_sharpe, ks_3_sharpe, 
      BAC_2_sharpe, BAC_3_sharpe,
      BG_2_sharpe, BG_3_sharpe)
...
rbind(dRMSE_ks_reg47, dRMSE_ks_reg90, dRMSE_ks_reg00,
      dRMSE_BAC_2, dRMSE_BAC_3,
      dRMSE_BG_2, dRMSE_BG_3)
################################################################################
...
model2_IS_R2 <- c(ks_2_IS_R2, BAC_2_IS_R2, 0) #, BG_1_IS_R2) #zero is placeholder due to problems running full data set on some machines
...
sharpes <- c(0, ks_2_sharpe, ks_3_sharpe, #zero is a placeholder for: ks_1_sharpe
             0, BAC_2_sharpe, BAC_3_sharpe, #BAC_1_sharpe
             0, BG_2_sharpe, BG_3_sharpe) #BG_1_sharpe
